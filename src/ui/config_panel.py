...
from textual.widgets import Switch, Input, Button, Static
...
class ConfigPanel(Widget):
    ...
    def __init__(self) -> None:
        ...
        self.NUMERIC_CONFIGS = {
            "opacity": NumericInput(default=100, min_value=30, max_value=100)
        }
    ...
    def compose(self) -> ComposeResult:
        ...
        with Vertical():
            ...
            with Vertical(classes="config-section"):
                ...
                yield Switch(value=self.config.theme.matrix_effect, id="matrix_theme")
                yield Input(
    ...
    def load_config(self) -> None:
        ...
        try:
            ...
            self.query_one("#opacity", Input).value = str(self.NUMERIC_CONFIGS["opacity"].default)
...
class NumericInput(Input):
    """Stub for NumericInput for test compatibility."""
    def __init__(self, default=100, min_value=30, max_value=100):
        super().__init__()
